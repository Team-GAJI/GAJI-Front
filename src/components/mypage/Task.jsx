...
const Task = ({ selectedDate }) => {
    ...
    return (
        ...
        <TaskWrapper>
            ...
            <AddSceduleButton onClick={()=>handleTaskModal()}><PlusIcon/>{taskModal ? '추가 완료' : '일정 추가하기' }</AddSceduleButton>
            {taskModal && 
            <AddTaskModal>
                <Title1>일정 추가하기</Title1>
                <Descreption>일정은 하루에 10개 추가할 수 있어요</Descreption>
                <Line/>
                <Title2>일정 제목</Title2>
                ...
                <RowWrapper>
                    <ReapetCheck/><Text>반복 일정</Text><Descreption2>일정을 매주 반복합니다</Descreption2>
                </RowWrapper>
            </AddTaskModal>
        }
        </TaskWrapper>
...
const ReapetCheck = styled(TaskCheckBox)`
    width : 1em;
    height : 1em;
...
const AddSceduleButton = styled(PuppleButton)`
    position : absolute;
    bottom : 0;
    left: 50%;  
