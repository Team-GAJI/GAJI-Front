...
const studyCreateSlice = createSlice({
    ...
    reducers: {
        ...
        setMaterialList: (state, action) => { state.materialList = action.payload; },
        setRecruitStartDay: (state, action) => { state.recruitStartDay = action.payload; },
        setRecruitEndDay: (state, action) => { state.recruitEndDay = action.payload; },
        setStudyStartDay: (state, action) => { state.studyStartDay = action.payload; },
