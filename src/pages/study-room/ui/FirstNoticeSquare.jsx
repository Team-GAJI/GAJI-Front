...
const FirstNoticeSquare = ({ notice, isHovered, onMouseEnter, onMouseLeave, onMoveToTop }) => {
    ...
    return (
        <NoticeSquareWrapper isHovered={isHovered} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
            <ColumnWrapper>
                <InputWrapper>
                    <AlarmIcon src={NoticeAlarm} alt="공지" isHovered={isHovered} onClick={onMoveToTop} />
                ...
                <Container1>
                    ...
                    <CheckButton onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                        <span>확인</span>
                        <span>{notice.checks}</span>
                        <CheckTooltip
                            users={['user1023', 'user2045', 'user3098', 'user4567', 'user5678']}
