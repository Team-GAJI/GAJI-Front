    ...
    return (
        <>
            ...
            <StudyCurriculumDescreption>
                4주차 스터디 상세설명 입니다 4주차 스터디 상세설명 입니다 4주차 스터디 상세설명 입니다 4주차 스터디
                상세설명 입니다 4주차 스터디 상세설명 입니다 4주차 스터디 상세설명 입니다 4주차 스터디 상세설명 입니다
                4주차 스터디 상세설명 입니다 4주차 스터디 상세설명 입니다 4주차 스터디 상세설명 입니다 4주차 스터디
                상세설명 입니다 4주차 스터디 상세설명 입니다
            </StudyCurriculumDescreption>
                ...
                <NinckNameList>
                    {nicknames.map((nickname, index) => (
                        ...
                        >
                            ...
                            {hoveredNickname === nickname && <CloudyText>{nickname}</CloudyText>}
                        </Circle>
                    ))}
                </NinckNameList>
                <TaskWrapper>
...
const TaskItem = styled.div`
    ...
    &::before {
        ...
        border: 0.0625em solid ${(props) => (props.isActive ? '#8E59FF' : '#8E59FF')};
