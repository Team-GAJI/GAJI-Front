...
import Logo from "../../logos/logo.svg"; // 올바른 경로로 수정
import backImage from "../../images/mypageBackground.png"; // 올바른 경로로 수정
import Footer from "../../../pages/Footer"; // 올바른 경로로 수정
        ...
        <ContentWrapper>
          ...
          <RowSelectWrapper>
            <Container>
              ...
              >
                <SelectButtonContent>{selectedCategory}</SelectButtonContent>
            ...
            <Container>
              <SelectButton onClick={handleSortingClick}>
                {selectedSorting}
                <Icons
                  src={Arrow}
                  alt="아래보기"
            ...
            <Container>
              ...
              >
                <SelectButtonContent>{selectedFilter}</SelectButtonContent>
                <Icons src={Arrow} alt="아래보기" />
              </SelectButton>
              {showFilter && (
                <AbsoluteContainer3>
            ...
            <CreateButton>
              <Icons
                src={Plus}
                alt="플러스"
                style={{ width: "0.625em", height: "auto" }}
              />
              스터디 만들기
            </CreateButton>
          </RowSelectWrapper>
