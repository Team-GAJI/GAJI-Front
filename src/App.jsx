...
import StudyNoticeRegistrationPage from "./pages/StudyNoticeRegistrationPage.jsx";
  ...
  return (
    <Routes>
      ...
      <Route element={<MainLayOut />}>
        ...
        <Route exact path="/studycategory" element={<StudyCategoryPage />} />
        {/* 스터디 카테고리별 둘러보기 페이지 */}

        <Route exact path="/studydetail" element={<StudyDetailPage />} />
        {/* 특정 스터디의 상세 정보 페이지 */}

        <Route exact path="/studymanage" element={<StudyManagePage />} />
        {/* 스터디 관리 페이지 */}

        <Route
          exact
          path="/studyweekmanage"
        ...
        <Route exact path="/studyroom/post" element={<StudyRoomPostPage/>}/>
        ...
        <Route
          path="/studynotice-register"
          element={<StudyNoticeRegistrationPage />}
        />
        {/* 스터디 공지사항 등록 페이지 */}
